---
schema: liveme
title: 2024-Shb-Trento-Headset Plug Event
organization: name  # Copyright Holders in the config file 
notes: Headset status (true/false), triggered when the jack of the headphones is plugged in/out
resources:
    - name: codebook
      # URL must link to the corresponding codebook
      url: >-
          /liveme/documentation/codebooks/headsetplug.html
      format: html
...
publication_date: 2024-10-19 17:09:18  # Current timestamp
identifier: 007.AAAO.AAA.AH  # Generated based on the defined rules
