---
schema: liveme
title: 2024-Shb-Trento-Battery Monitoring Log
organization: name  # Copyright Holders in the config file 
notes: Returns the phone's battery level
resources:
    - name: codebook
      # URL must link to the corresponding codebook
      url: >-
          /liveme/documentation/codebooks/batterylevel.html
      format: html
...
publication_date: 2024-10-19 17:08:41  # Current timestamp
identifier: 007.AAAO.AAA.BU  # Generated based on the defined rules
