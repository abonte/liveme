---
schema: liveme
title: 2024-Shb-Trento-Application Event
organization: name  # Copyright Holders in the config file 
notes: Returns the name of the application (or application package) that is currently running in the foreground of the phone
resources:
    - name: codebook
      # URL must link to the corresponding codebook
      url: >-
          /liveme/documentation/codebooks/applications.html
      format: html
...
publication_date: 2024-10-19 17:08:59  # Current timestamp
identifier: 007.AAAO.AAA.AG  # Generated based on the defined rules
