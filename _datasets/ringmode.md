---
schema: liveme
title: 2024-Shb-Trento-Ring Mode Event
organization: name  # Copyright Holders in the config file 
notes: Returns the current ring status of the phone (normal/silent/vibrate)
resources:
    - name: codebook
      # URL must link to the corresponding codebook
      url: >-
          /liveme/documentation/codebooks/ringmode.html
      format: html
...
publication_date: 2024-10-19 17:08:48  # Current timestamp
identifier: 007.AAAO.AAA.BW  # Generated based on the defined rules
